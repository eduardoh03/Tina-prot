...
public class TinaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Eduardo Henrique", "eduhenriquesrs@gmail.com", "(89) 99921-7065",
				"363.789.123-77", SexoCliente.MASCULINO);
		Cliente cli2 = new Cliente(null, "Maria Fernanda", "maria@yahool.com", "(89) 12354-0765",
				"541.896.513-54", SexoCliente.FEMININO);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2020 09:35"), cli1, e2);
